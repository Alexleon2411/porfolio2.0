<template>
   ...
   <section class="section" id="portfolio">
        <div class="container text-center">
            ...
            <div class="row">
                <div class="col-md-6">
                    <a href="https://www.free-will.me" class="portfolio-card" target="_blank">
                        <img src="../imgs/Captura de pantalla 2023-06-21 a las 19.42.40.png" class="portfolio-card-img" alt="Download free bootstrap 4 landing page, free boootstrap 4 templates, Download free bootstrap 4.1 landing page, free boootstrap 4.1.1 templates, meyawo Landing page">
